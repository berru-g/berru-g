...
<head>
    ...
    <meta name="description" content="Remplacez Google Analytics par Libre Analytics, la solution analytics souveraines : Dashboard simple, conforme RGPD, installation 2min. Premier dashboard gratuit.">
    ...
    <div class="cookie-container">
        ...
        <div class="cookie-content">
            <p class="cookie-description">
                ...
                J'utilise <strong>Libre Analytics</strong>, mon propre système d'analyse développé avec éthique, dans le respect
                des lois RGPD.
            </p>
            <p class="cookie-description">
