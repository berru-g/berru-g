...
requireLogin(); // Vérifie la connexion

// CSS de ton header (le fichier que tu as partagé)
$headerCss = file_get_contents(__DIR__ . '/../header.css');
?>
<!DOCTYPE html>
<html lang="en">
<!-- 
...
<head>
  ...
  <title>Web souverains et sur mesure</title>
    ...
    <div class="aside">
      <button popovertarget="sidebar" popovertargetaction="toggle" class="toggle">
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path class="icon-bar" d="M4.75 10H11V18.5H5.75C5.19772 18.5 4.75 18.0523 4.75 17.5V10Z"
            fill="currentColor" />
        </svg>
        ...
        <header>
          <a class="button-link" aria-label="Home" href="/">
            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="m15.7227 7.75 4.9996 13.5001M8.13672 14.2656 20.724 21.2521" stroke="currentColor"
              ...
              <path
                ...
                fill="currentColor"></path>
              <path d="m15.6133 8.16406-5.1156-2.66251" stroke="currentColor" stroke-width="1.2" stroke-linecap="round">
              </path>
            </svg>
          </a>
          ...
          <form>
            <div class="tree-search-input-container">
              ...
              <input type="input" id="tree-search" placeholder="Find" aria-label="Filter navigation tree"
